...
public class MainActivity extends AppCompatActivity {
    private TextInputLayout textBedrooms, textMonthlyRentPrice, textNotes, textNameReporter;
    ...
    ArrayAdapter<String> adapterItems_Property, adapterItems_Furniture;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textBedrooms = findViewById(R.id.bedrooms);
    ...
    private boolean validateBedrooms(){
        String val = textBedrooms.getEditText().getText().toString().trim();

        if (val.isEmpty()){
            textBedrooms.setError("Field can not be empty!");
            return false;
        }
        else {
            textBedrooms.setError(null);
            return true;
        }
    }
    ...
    public void confirmInput(View v){
        if (!validateBedrooms() && !validateDateAndMonth() && !validateMonthlyRentPrice() && !validateNameOfTheReporter()){
            return;
        }
    }
